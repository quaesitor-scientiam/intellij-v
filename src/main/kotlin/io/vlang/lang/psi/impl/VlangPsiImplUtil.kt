...
import io.vlang.lang.psi.impl.VlangReferenceBase.Companion.NOT_PROCESS_EMBEDDED_DEFINITION
import io.vlang.lang.psi.impl.imports.VlangModuleReference
import io.vlang.lang.psi.types.*
import io.vlang.lang.psi.types.VlangBaseTypeEx.Companion.isGeneric
...
import io.vlang.utils.stubOrPsiParentOfType
...
object VlangPsiImplUtil {
    ...
    fun getParentVlangValue(element: PsiElement): VlangValue? {
        ...
        while (PsiTreeUtil.getParentOfType(place, VlangLiteralValueExpression::class.java)
                .also { place = it } != null
        ) {
